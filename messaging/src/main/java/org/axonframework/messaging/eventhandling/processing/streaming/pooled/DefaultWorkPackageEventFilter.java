...
class DefaultWorkPackageEventFilter implements WorkPackage.EventFilter {
     ...
     * <p>
     * When any of the components returns the {@link SequencingPolicy#BROADCAST} sequence identifier for the given
     * {@code eventMessage}, segment matching is skipped and the event is handled by every segment.
     *
