...
class WelcomeMessageBetaCleanupViaListTest {
    ...
    @Nested
    class LiftsEveryListedBetaVersion {
    ...
    @Nested
    class OnlyListedVersionsAreMatched {

        @Test
        void aVersionNotInTheListIsLeftUntouched() {
            ...
            TransformationTester.forTransformation(WelcomeMessageBetaCleanupViaList.build())
                                ...
                                .then()
                                .success()
                                .outputType(new MessageType(CourseCatalogMessageNames.WELCOME_MESSAGE_SENT, "0.6"))
                                .outputPayloadFromResource("/transformations/welcomemessagesent/v0_5.json");
        }
    }
