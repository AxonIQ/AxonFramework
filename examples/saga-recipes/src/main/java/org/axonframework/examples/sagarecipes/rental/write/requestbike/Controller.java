...
class Controller {
    ...
    @PostMapping
    ResponseEntity<Void> request(@PathVariable("bikeId") String bikeId, @RequestBody Request request) {
        commandGateway.sendAndWait(new RequestBike(BikeId.of(bikeId), request.renter(),
