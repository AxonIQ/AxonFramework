 ...
 * back into the {@link Course} that summarizes the seats taken so far, from that tenant's own event
 * store.
 *
 * @param courseId  the identifier of the course enrolled in
 * @param studentId the identifier of the enrolled student
 */
public record StudentEnrolledInCourse(@EventTag(key = CourseTags.COURSE_ID) String courseId,
                                      String studentId) {
