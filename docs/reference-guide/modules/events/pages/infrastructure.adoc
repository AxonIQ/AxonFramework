...
[source,java]
----
include::example$events/infrastructure/jpa/MyEntityManagerProvider.java[tag=custom-entity-manager-provider,indent=0]
----
...
[source,java]
----
include::example$events/infrastructure/jpa/configapi/AxonConfig.java[tag=jpa-storage-engine-configapi,indent=0]
----
--
...
[source,java]
----
include::example$events/infrastructure/jpa/springboot/AxonConfig.java[tag=jpa-storage-engine-springboot,indent=0]
----
--
======
...
[source,java]
----
include::example$events/infrastructure/inmemory/configapi/AxonConfig.java[tag=inmemory-storage-engine-configapi,indent=0]
----
--
...
[source,java]
----
include::example$events/infrastructure/inmemory/springboot/AxonConfig.java[tag=inmemory-storage-engine-springboot,indent=0]
----
--
====
