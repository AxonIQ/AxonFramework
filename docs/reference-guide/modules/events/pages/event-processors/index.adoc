...
[source,java]
----
include::example$events/eventprocessors/index/declarative/AxonConfig.java[tag=declarative-subscribing-processor,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/index/lifecycle/ProcessorStateChecker.java[tag=processor-state-checker,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/index/errorhandling/defaults/AxonConfig.java[tag=error-handler-default,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/index/errorhandling/specific/AxonConfig.java[tag=error-handler-specific-processor,indent=0]
----
--
====
...
[source,java]
----
include::example$events/eventprocessors/index/interceptors/instance/AxonConfig.java[tag=processor-specific-interceptor,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/index/interceptors/component/AxonConfig.java[tag=intercepted-handling-components,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/index/interceptors/exceptionhandler/ExceptionHandlingConfig.java[tags=with-exception-handler-import;with-exception-handler,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/index/interceptors/annotated/before/AuditingEventHandler.java[tag=event-handler-interceptor-before,indent=0]
----

[source,java]
----
include::example$events/eventprocessors/index/interceptors/annotated/surround/TenantScopedEventHandler.java[tag=event-handler-interceptor-surround,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/index/interceptors/annotated/exceptionhandler/MyEventHandler.java[tag=annotated-exception-handler,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/index/monitors/AxonConfig.java[tag=register-event-monitor,indent=0]
----