...
link:https://platform.axoniq.io/[Axoniq Platform,role=external,window=_blank] is the platform to monitor and manage your Axon Framework applications in great detail.
...
|xref:monitoring:tracing.adoc[Tracing] |Distributed tracing support built into Axon Framework
endif::[]
