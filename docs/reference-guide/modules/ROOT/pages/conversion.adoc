...
[source,java]
----
include::example$root/conversion/messagetypes/UserRegistrationHandlers.java[tag=full-object-handler,indent=0]
----
...
[source,java]
----
include::example$root/conversion/messagetypes/UserRegistrationHandlers.java[tag=json-node-handler,indent=0]
----
...
[source,java]
----
include::example$root/conversion/messagetypes/UserRegistrationHandlers.java[tag=converted-payload-handler,indent=0]
----
...
[source,java]
----
include::example$root/conversion/messagetypes/ConverterAttachment.java[tag=attach-converter-to-message,indent=0]
----
...
[source,java]
----
include::example$root/conversion/implementations/jackson/CustomJacksonConverter.java[tag=custom-jackson-converter,indent=0]
----
...
[source,java]
----
include::example$root/conversion/implementations/jackson/XmlJacksonConverter.java[tag=xml-jackson-converter,indent=0]
----
...
[source,java]
----
include::example$root/conversion/implementations/avro/AvroConverterExample.java[tag=build-avro-converter,indent=0]
----
...
[source,java]
----
include::example$root/conversion/implementations/custom/MyCustomConverter.java[tag=custom-converter,indent=0]
----
...
[source,java]
----
include::example$root/conversion/configuration/plainjava/AxonConfig.java[tag=converter-configuration,indent=0]
----
...
[source,java]
----
include::example$root/conversion/configuration/springboot/ConverterConfiguration.java[tag=converter-configuration-springboot,indent=0]
----
...
[source,java]
----
include::example$root/conversion/configuration/avroevents/AxonConfig.java[tag=avro-events-configuration,indent=0]
----
...
[source,java]
----
include::example$root/conversion/tuning/lenient/ConverterConfiguration.java[tag=lenient-jackson-converter,indent=0]
----
...
[source,java]
----
include::example$root/conversion/tuning/generics/MyEvent.java[tag=json-type-info-field,indent=0]
----
...
[source,java]
----
include::example$root/conversion/tuning/generics/DefaultTypingExample.java[tag=default-typing-object-mapper,indent=0]
----
...
[source,java]
----
include::example$root/conversion/tuning/contenttype/MyContentTypeConverter.java[tag=custom-content-type-converter,indent=0]
----
...
[source,java]
----
include::example$root/conversion/tuning/contenttype/ContentTypeConverterRegistration.java[tag=register-custom-content-type-converter,indent=0]
----
