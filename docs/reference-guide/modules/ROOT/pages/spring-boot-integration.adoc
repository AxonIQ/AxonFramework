...
[source,java]
----
include::example$root/springbootintegration/EventProcessorConfig.java[tag=order-processor-definition,indent=0]
----
...
[source,java]
----
include::example$root/springbootintegration/NamespaceBasedProcessorConfig.java[tags=namespace-processor-import;namespace-processor;namespace-event-handler,indent=0]
----
...
[source,java]
----
include::example$root/springbootintegration/EventProcessorDefinitionExamples.java[tag=namespace-convenience-methods,indent=0]
----
...
[source,java]
----
include::example$root/springbootintegration/EventProcessorDefinitionExamples.java[tag=event-processor-configuration-options,indent=0]
----
