...
[source,java]
----
include::example$messagingconcepts/anatomymessage/PayloadRepresentations.java[tag=payload-representations,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/PayloadAccess.java[tag=accessing-payload,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/PayloadAccess.java[tag=payload-conversion-aware,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/PayloadAccess.java[tag=explicit-converter,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/PayloadAccess.java[tag=attach-converter,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/PayloadAccess.java[tag=convert-payload,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/WorkingWithMetadata.java[tag=creating-metadata,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/WorkingWithMetadata.java[tag=adding-metadata,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/WorkingWithMetadata.java[tag=metadata-string-values,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/PayloadAccess.java[tag=message-identifier,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/anatomymessage/CreatingMessages.java[tag=creating-messages,indent=0]
----
