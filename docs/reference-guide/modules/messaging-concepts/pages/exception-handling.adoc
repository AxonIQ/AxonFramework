...
[source,java]
----
include::example$messagingconcepts/exceptionhandling/results/InventoryAutomation.java[tag=result-object,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/exceptionhandling/exceptions/InventoryAutomation.java[tag=infrastructure-exception,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/exceptionhandling/details/InventoryAutomation.java[tag=exception-details,indent=0]
----
