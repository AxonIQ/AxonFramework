...
|type: `Segment` |Will resolve to the xref:events:event-processors/streaming.adoc[segment] that the streaming event processor assigned to the handler for the processed event. This identifies the slice of the event stream the handler is responsible for. Resolves to `null` when the event is not processed by a streaming event processor, as there is no segment in that scenario.
...
[source,java]
----
include::example$messagingconcepts/supportedparameters/BasicCommandHandlerExample.java[tag=command-handler-event-appender,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/supportedparameters/EventHandlerProcessingContextExample.java[tag=event-handler-processing-context,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/supportedparameters/EventHandlerMetadataTimestampExample.java[tag=event-handler-metadata-timestamp,indent=0]
----

=== Query handler with `ProcessingContext`
[source,java]
----
include::example$messagingconcepts/supportedparameters/QueryHandlerProcessingContextExample.java[tag=query-handler-processing-context,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/supportedparameters/EventHandlerQueryUpdateEmitterExample.java[tag=event-handler-query-update-emitter,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/supportedparameters/EventHandlerCommandDispatcherExample.java[tag=event-handler-command-dispatcher,indent=0]
----
...
[source,java]
----
include::example$messagingconcepts/supportedparameters/EventHandlerReplayContextExample.java[tag=event-handler-replay-context,indent=0]
----