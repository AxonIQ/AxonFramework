...
* xref:migration:paths/sagas.adoc[Saga and Deadline migration]
...
- **Saga and Deadline infrastructure**: The Axon Framework 4 Saga and Deadline APIs do not have direct replacements. New processes can use the xref:saga-guide::index.adoc[Saga Pattern and Process Managers guide], but migration of active Saga state and already scheduled deadlines is not available. See xref:migration:paths/sagas.adoc[the Saga and Deadline migration path].
