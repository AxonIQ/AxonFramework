...
[source,java]
----
include::example$migration/paths/eventstore/axonserver/configapi/defaultcontext/AxonConfig.java[tag=axonserver-storage-engine,indent=0]
----
...
[source,java]
----
include::example$migration/paths/eventstore/axonserver/configapi/customcontext/AxonConfig.java[tag=axonserver-storage-engine-context,indent=0]
----
--
...
[source,java]
----
include::example$migration/paths/eventstore/axonserver/springboot/defaultcontext/AxonConfig.java[tag=axonserver-storage-engine-springboot,indent=0]
----
...
[source,java]
----
include::example$migration/paths/eventstore/axonserver/springboot/customcontext/AxonConfig.java[tag=axonserver-storage-engine-springboot-context,indent=0]
----
...
[source,java]
----
include::example$migration/paths/eventstore/eventtyperesolver/configapi/AxonConfig.java[tag=event-type-resolver-configuration,indent=0]
----
--
...
[source,java]
----
include::example$migration/paths/eventstore/eventtyperesolver/springboot/AxonConfig.java[tag=event-type-resolver-springboot,indent=0]
----
--
====
...
[source,java]
----
include::example$migration/paths/eventstore/jpastorageengine/defaultconfig/AxonConfig.java[tag=jpa-storage-engine-configuration,indent=0]
----
...
[source,java]
----
include::example$migration/paths/eventstore/jpastorageengine/customconfig/AxonConfig.java[tag=jpa-storage-engine-custom-configuration,indent=0]
----
--
