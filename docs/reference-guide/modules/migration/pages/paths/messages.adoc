...
----
// AF5
include::example$migration/paths/messages/MyEvent.java[tag=explicit-message-type,indent=0]
----
...
----
// AF5
include::example$migration/paths/messages/MarkOrderAsShippedCommand.java[tag=target-entity-id,indent=0]
----
...
----
// AF5
include::example$migration/paths/messages/MyCommand.java[tag=command-routing-key,indent=0]
----
...
// AF5
include::example$migration/paths/messages/OrderCreatedEvent.java[tag=event-tag-aggregate-identification,indent=0]
----
