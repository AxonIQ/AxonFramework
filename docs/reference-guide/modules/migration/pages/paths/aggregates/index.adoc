...
[source,java]
----
include::example$migration/paths/aggregates/index/simpleexample/GiftCard.java[tag=simple-example,indent=0]
----
...
[source,java]
----
include::example$migration/paths/aggregates/index/entitycreatorstatic/GiftCard.java[tag=entity-creator-static,indent=0]
----
...
[source,java]
----
include::example$migration/paths/aggregates/index/entitycreatorpatterns/noargument/GiftCard.java[tag=entity-creator-noarg,indent=0]
----
...
[source,java]
----
include::example$migration/paths/aggregates/index/entitycreatorpatterns/identifier/GiftCard.java[tag=entity-creator-identifier,indent=0]
----
...
[source,java]
----
include::example$migration/paths/aggregates/index/entitycreatorpatterns/firstevent/GiftCard.java[tag=entity-creator-firstevent,indent=0]
----
...
[source,java]
----
include::example$migration/paths/aggregates/index/eventappender/GiftCard.java[tag=event-appender,indent=0]
----
...
[source,java]
----
include::example$migration/paths/aggregates/index/creationpolicyalways/GiftCard.java[tag=creation-policy-always,indent=0]
----
...
----
+
Alternatively, if you want to keep the create-if-missing logic on an **instance** command handler, closer to how `@CreationPolicy(CREATE_IF_MISSING)` worked in Axon Framework 4, use a no-argument or identifier-based `@EntityCreator`. Such a creator always constructs the entity, even when it does not yet exist, so the instance handler receives a non-null entity and can decide for itself whether to append the event that establishes its existence.
+
[source,java]
----
