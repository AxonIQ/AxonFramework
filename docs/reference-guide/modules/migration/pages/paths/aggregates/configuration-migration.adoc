...
[source,java]
----
include::example$migration/paths/aggregates/configurationmigration/AxonConfig.java[tag=register-entity-module,indent=0]
----
...
[source,java]
----
include::example$migration/paths/aggregates/configurationmigration/springboot/GiftCard.java[tag=event-sourced-spring,indent=0]
----
