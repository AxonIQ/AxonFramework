...
[source,java]
----
include::example$migration/understandingarchitectureprinciples/configurercomposition/AxonConfig.java[tag=configurer-composition,indent=0]
----
...
[source,java]
----
include::example$migration/understandingarchitectureprinciples/processingcontext/MyEventHandler.java[tag=processing-context,indent=0]
----
...
[source,java]
----
include::example$migration/understandingarchitectureprinciples/eventstorageenginebean/AxonConfig.java[tag=event-storage-engine-bean,indent=0]
----
...
[source,java]
----
include::example$migration/understandingarchitectureprinciples/xmlconversion/XmlConversionExample.java[tag=xml-conversion,indent=0]
----
...
[source,java]
----
include::example$migration/understandingarchitectureprinciples/eventversioning/AccountCreatedEvent.java[tag=account-created-event,indent=0]
----
