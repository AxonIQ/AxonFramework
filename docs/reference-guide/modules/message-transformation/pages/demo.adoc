...
The demo composes a chain of transformers, each illustrating a technique covered here:
...
| a xref:defining-transformations.adoc#_mapping_to_a_typed_event[typed mapper] to the current event that, with the previous transformer, shows xref:configuring-transformations.adoc#_why_ordering_matters[chaining in version order]
