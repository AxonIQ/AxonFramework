...
[source,java]
----
include::example$tuning/snapshotting/policies/SnapshotPolicyExamples.java[tag=combined-snapshot-policy,indent=0]
----
...
[source,java]
----
include::example$tuning/snapshotting/storeconfig/InMemorySnapshotStoreConfiguration.java[tag=in-memory-snapshot-store,indent=0]
----
...
[source,java]
----
include::example$tuning/snapshotting/annotationbased/afterevents/Course.java[tag=snapshot-after-events,indent=0]
----
...
[source,java]
----
include::example$tuning/snapshotting/annotationbased/combinedthresholds/Course.java[tag=snapshot-combined-thresholds,indent=0]
----
...
[source,java]
----
include::example$tuning/snapshotting/programmatic/SnapshotPolicyConfiguration.java[tag=declarative-snapshot-policy,indent=0]
----
...
[source,java]
----
include::example$tuning/snapshotting/entityconversion/getterbased/Course.java[tag=getter-based-course,indent=0]
----
...
[source,java]
----
include::example$tuning/snapshotting/entityconversion/recordbased/Course.java[tag=record-based-course,indent=0]
----
