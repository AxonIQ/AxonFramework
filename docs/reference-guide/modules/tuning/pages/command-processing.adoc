...
[source,java]
----
include::example$tuning/commandprocessing/TenantBasedSequencingPolicy.java[tag=custom-policy,indent=0]
----
...
[source,java]
----
include::example$tuning/commandprocessing/configapi/AxonConfig.java[tag=register-policy,indent=0]
----
--
...
[source,java]
----
include::example$tuning/commandprocessing/springboot/MessagingConfiguration.java[tag=register-policy-spring-boot,indent=0]
----
--
====
...
[source,java]
----
include::example$tuning/commandprocessing/disabling/AxonConfig.java[tag=disable-policy,indent=0]
----
