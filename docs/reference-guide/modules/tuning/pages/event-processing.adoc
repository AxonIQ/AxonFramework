...
[source,java]
----
include::example$tuning/eventprocessing/PooledStreamingProcessorConfiguration.java[tag=configure-pooled-streaming,indent=0]
----
...
[source,java]
----
include::example$tuning/eventprocessing/NotificationAutomationConfiguration.java[tag=notification-processor-definition,indent=0]
----
