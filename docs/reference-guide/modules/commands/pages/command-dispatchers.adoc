...
[source,java]
----
include::example$commands/commanddispatchers/CommandBusDispatchExample.java[tag=dispatching-with-commandbus,indent=0]
----
...
When command handling fails, the `CompletableFuture` completes exceptionally; on success, the `CommandResultMessage` carries the result of the command handler.
...
[source,java]
----
include::example$commands/commanddispatchers/AsyncSendExample.java[tag=async-send,indent=0]
----
...
[source,java]
----
include::example$commands/commanddispatchers/SendVariantsExample.java[tags=send-with-metadata;send-with-context;send-with-metadata-and-context;send-and-get-future,indent=0]
----
...
[source,java]
----
include::example$commands/commanddispatchers/SendAndWaitExample.java[tag=send-and-wait,indent=0]
----
...
[source,java]
----
include::example$commands/commanddispatchers/GiftCard.java[tag=injecting-command-dispatcher,indent=0]
----
...
[source,java]
----
include::example$commands/commanddispatchers/DispatcherApiExample.java[tags=dispatcher-send;dispatcher-send-metadata;dispatcher-send-future;dispatcher-send-handlers,indent=0]
----
...
[source,java]
----
include::example$commands/commanddispatchers/IssueCardCommand.java[tag=routing-key-with-command,indent=0]
----
...
[source,java]
----
include::example$commands/commanddispatchers/RoutingConfigurationExample.java[tag=custom-routing-strategy-config,indent=0]
----
...
[source,java]
----
include::example$commands/commanddispatchers/AxonConfig.java[tag=spring-routing-strategy,indent=0]
----
...
[source,java]
----
include::example$commands/commanddispatchers/CustomRoutingStrategy.java[tag=custom-routing-strategy,indent=0]
----
