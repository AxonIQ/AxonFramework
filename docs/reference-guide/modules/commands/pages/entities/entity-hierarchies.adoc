...
[source,java]
----
include::example$commands/entities/entityhierarchies/CourseEntity.java[tag=parent-entity,indent=0]
include::example$commands/entities/entityhierarchies/EnrollmentEntity.java[tag=child-entity,indent=0]
----
...
[source,java]
----
include::example$commands/entities/entityhierarchies/CourseCreated.java[tag=tagged-event,indent=0]
include::example$commands/entities/entityhierarchies/StudentEnrolled.java[tag=tagged-event,indent=0]
include::example$commands/entities/entityhierarchies/EnrollmentDropped.java[tag=tagged-event,indent=0]
----
...
[source,java]
----
include::example$commands/entities/entityhierarchies/AxonConfiguration.java[tag=declarative-child-wiring,indent=0]
----
...
[source,java]
----
include::example$commands/entities/entityhierarchies/autodetected/CourseEntity.java[tag=autodetected-entity,indent=0]
----
...
[source,java]
----
include::example$commands/entities/entityhierarchies/DropEnrollment.java[tag=drop-enrollment-command,indent=0]
----
...
[source,java]
----
include::example$commands/entities/entityhierarchies/advancedrouting/CourseEntity.java[tag=custom-event-target-matcher,indent=0]
----
...
[source,java]
----
include::example$commands/entities/entityhierarchies/advancedrouting/CustomCommandTargetResolverExample.java[tag=custom-command-target-resolver,indent=0]
----
