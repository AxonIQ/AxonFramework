...
Without it, a `GiftCard?` parameter is indistinguishable from a non-null one, because the compiler records Kotlin nullability in a form that is not visible at runtime.
