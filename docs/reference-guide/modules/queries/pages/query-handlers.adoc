...
[source,java]
----
include::example$queries/queryhandlers/FetchCardSummaryQuery.java[tag=fetch-card-summary-query,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/CardSummaryProjection.java[tag=card-summary-projection,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/matching/FetchCardSummaryQuery.java[tag=fetch-card-summary-query-with-getter,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/matching/CardSummaryHandler.java[tag=handle-fetch-card-summary,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/matching/MapRepresentationHandler.java[tag=handle-map-representation,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/matching/PayloadConversionHandlers.java[tag=payload-conversion-handlers,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/parameters/ProcessingContextExample.java[tag=query-handler-processing-context,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/parameters/QueryChainingExample.java[tags=dispatch-with-processing-context-import;dispatch-with-processing-context,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/emitter/CardSummaryProjection.java[tag=query-update-emitter,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/emitter/wrong/CardSummaryProjection.java[tag=emitter-field-injection-wrong,indent=0]
include::example$queries/queryhandlers/emitter/correct/CardSummaryProjection.java[tag=emitter-parameter-injection-correct,indent=0]
----
====
...
[source,java]
----
include::example$queries/queryhandlers/parameters/MetadataParametersExample.java[tags=metadata-and-value-parameters-import;metadata-and-value-parameters,indent=0]
----
...
[source,java]
----
include::example$queries/queryhandlers/returnvalues/PrimitiveQueryHandler.java[tag=primitive-return-type,indent=0]
----
