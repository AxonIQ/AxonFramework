...
Count: 43 anchored IDs, all filled with real guarantees. 5 are negative results carried as
...
### A.3 Missing claims M1-M21 (verification of the section 1c list, plus new gaps)
