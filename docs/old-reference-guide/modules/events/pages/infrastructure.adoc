...
The JVM system property `optimize-event-consumption` (for example `-Doptimize-event-consumption=false`) continues to work as before and takes precedence over this property.
====
