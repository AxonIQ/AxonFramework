...
Hence, as of 4.13., Axon Framework 4 support Spring Boot 4+.
...
- [#4073] Support for Spring Boot 4 and Jackson 3 link:https://github.com/AxonFramework/AxonFramework/pull/4136[#4136]
