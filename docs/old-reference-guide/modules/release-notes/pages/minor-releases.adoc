...
- link:https://github.com/abuijze[@abuijze]
- link:https://github.com/hatzlj[@hatzlj]
- [@link:https://github.com/CodeDrivenMitchCodeDrivenMitch]
...
link:https://github.com/AxonFramework/AxonFramework/pull/3537If your application uses the `JobRunrEventScheduler` or `JobRunrDeadlineManager`, be sure to upgrade to JobRunr 8!
